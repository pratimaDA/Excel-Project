...
Analytical Skills learned : How we can show performance of the market just by calculating sales per year and comparing it with target.
...
To calculate values for some key business KPIs.
